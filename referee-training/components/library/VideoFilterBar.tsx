      ...
      >
        <div className="max-w-screen-2xl mx-auto px-4 py-3">
          ...
          <div className="flex items-start gap-3">
            ...
            {/* Settings Gear */}
            <div className="relative flex-shrink-0 self-start" ref={settingsRef}>
              <button
                onClick={() => setShowSettings(!showSettings)}
                className="px-2 py-2 rounded-lg bg-dark-900 border border-dark-600 text-text-secondary hover:text-accent hover:border-accent transition-colors"
              ...
              {showSettings && (
                <div className="absolute top-full right-0 mt-2 w-64 max-w-[calc(100vw-2rem)] max-h-[70vh] overflow-y-auto rounded-lg bg-dark-900 border border-dark-600 shadow-2xl z-50 p-4">
