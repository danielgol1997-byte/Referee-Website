...
export function DecisionReveal({
  ...
  return (
    <>
      {/* Backdrop */}
      <div
        className="absolute inset-0 bg-black/90 z-[9200] transition-opacity duration-300"
        onClick={onClose}
      />

      {/* Modal */}
      <div className="absolute inset-0 z-[9210] flex items-center justify-center p-4 overflow-y-auto">
        <div
          className={cn(
